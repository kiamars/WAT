...
class backup_restore
{
     ...
     * @access private
     */
    public $path = 'D:\xampp\htdocs\GenerateTestSequenceForWebApplication\TestDataGenerationAlgorithm\Components\StateManager\DataBaseManager';
     ...
     * @return string $dir
     * @internal param bool $rel . (default: false)
     */
...
//	    mysql_set_charset( DB_CHARSET, $this->db );
        ...
        //   echo"****".$this->database_dump_filename."*****";


        // Read the backup file into string then remove the file
        $finalbackup = file_get_contents($this->get_database_dump_filepath());
    ...
    //Restore
    public function restore($lines = NULL)
    {
