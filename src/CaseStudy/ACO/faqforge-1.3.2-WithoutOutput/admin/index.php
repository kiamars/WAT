...
class ACO_Admin_Index_php extends ACO_PageTDG
{
    ...
    {
        $output = "";
        $BASEDIROFPROJECT = 'C:\xampp\htdocs\GenerateTestSequenceForWebApplication\CaseStudy\ACO\faqforge-1.3.2-WithoutOutput';
