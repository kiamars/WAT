...
require_once "VSPageObjectResolver.php";
...
//GerGInverse
//require_once $BASEDIROFPROJECT."/CaseStudy/VS/faqforge-1.3.2-WithoutOutput/VSTestHarness/SetGinv.php";
...
$PageObjectResolver = new VSPageObjectResolver();
...
$TestHarness = new SBTDGA($PageObjectResolver, $numberOfAllBranchInProgramUnderTest,"faqforge","VS");
