...
require_once $BASEDIROFPROJECT."/CaseStudy/VS/faqforge-1.3.2-WithoutOutput/index.php";
require_once $BASEDIROFPROJECT . "/TestDataGenerationAlgorithm/IPageObjectResolver.php";
require_once $BASEDIROFPROJECT."/CaseStudy/VS/faqforge-1.3.2-WithoutOutput/admin/index.php";
require_once $BASEDIROFPROJECT."/CaseStudy/VS/faqforge-1.3.2-WithoutOutput/admin/adminLogOut.php";
require_once $BASEDIROFPROJECT."/CaseStudy/VS/faqforge-1.3.2-WithoutOutput/admin/adminLogin.php";
class VSPageObjectResolver implements IReSolver
{
    ...
    public function Resolve($PageFilePath)
    {
        ...
        switch ($ClassName) {
            case FilePath::Admin_Index_php:
                $PageObject = new  VS_Admin_Index_php();
                $PageObject->InitializeInputListType();
                break;
            case FilePath::Index_php:
                $PageObject = new  VS_Index_PhP();
                $PageObject->InitializeInputListType();
                break;

            case FilePath::Admin_LogIn_php:
                $PageObject = new  VS_Admin_LogIn_php();
                $PageObject->InitializeInputListType();
                break;
            case FilePath::Admin_LogOut_php:
                $PageObject = new  VS_Admin_LogOut_php();
                $PageObject->InitializeInputListType();
                break;
        }
        if($PageObject==null)
