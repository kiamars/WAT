...
require_once $BASEDIROFPROJECT . "/TestDataGenerationAlgorithm/PSO_PageTDG.php";

class Admin_Index_php extends PSO_PageTDG
{
    ...
    public function InitializeInputListType()
    {
        ...
        $this->InputsType["topicOrder"] = new ITOI(6, "topicOrder",null, -100, 100);
    ...
    {
        $output = "";
        $BASEDIROFPROJECT = 'C:\xampp\htdocs\GenerateTestSequenceForWebApplication\CaseStudy\PSO\faqforge-1.3.2-WithoutOutput';
